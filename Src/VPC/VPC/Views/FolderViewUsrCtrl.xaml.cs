...
namespace VPC.Views
{
  ...
  {
    public static readonly DependencyProperty MUsProperty = DependencyProperty.Register("MUs", typeof(ObservableCollection<MediaUnit>), typeof(FolderViewUsrCtrl), new PropertyMetadata(null)); public ObservableCollection<MediaUnit> MUs { get { return (ObservableCollection<MediaUnit>)GetValue(MUsProperty); } set { SetValue(MUsProperty, value); } }
    ...
    public void MovCurrentToPrev()
    {
      ...
      dgMUnits.Items.MoveCurrentToPrevious();
    ...
    public void MovCurrentToNext()
    {
      ...
      dgMUnits.Items.MoveCurrentToNext();
  ...
  public class EmptyOnZero : IValueConverter
  {
    public object Convert(object value, System.Type targetType, object parameter, System.Globalization.CultureInfo culture)
    {
      ...
      if (value is long && (long)value == 0) return null;
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
      if (value is DateTime)
      {
        switch (((DateTime)value).DayOfWeek)
        {
          ...
          case DayOfWeek.Sunday: return new SolidColorBrush(Color.FromRgb(0xa0, 0x01, 0x01));
          default: return new SolidColorBrush(Color.FromRgb(0x01, 0x0001, 0xa0));
        }
      }
